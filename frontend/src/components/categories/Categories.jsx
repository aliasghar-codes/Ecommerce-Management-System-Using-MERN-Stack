...
export const categories = () => {
    return (
        <section className="pt-36 mx-40 border-b-2">
                <div className="heading">Categories</div>
                <h2 className='text-6xl font-semibold mt-16 mb-32'>
                    Browse By Category
                </h2>
                <div className="flex justify-between flex-wrap my-36">
                    <Link to="/products/category/phones" 
                        className="border-2 flex flex-col items-center justify-center w-[15%] py-14 rounded-lg text-2xl transition-all cursor-pointer hover:border-none hover:bg-red-500 hover:text-white" >
